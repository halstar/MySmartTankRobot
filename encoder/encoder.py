...
class Encoder:
    ...
    def __init__(self, gpio_interface, encoder_pin_1, encoder_pin_2):
        ...
        if self.gpio_interface == USE_RPI_GPIO:
            ...
            self.encoder_pin_1_device = gpiozero.DigitalInputDevice(encoder_pin_1, pull_up = True, bounce_time = BOUNCE_TIME / 1000)
            self.encoder_pin_2_device = gpiozero.DigitalInputDevice(encoder_pin_2, pull_up = True, bounce_time = BOUNCE_TIME / 1000)
    ...
    def callback(self, channel):
        ...
        # print("CB1 - ", pin_1_state, " / ", pin_2_state, " - ", self.counter)
    ...
    def callback2(self, gpio, level, tick):
        ...
        # print("CB2 - ", self.level_encoder_1, " / ", self.level_encoder_2, " - ", self.counter)
