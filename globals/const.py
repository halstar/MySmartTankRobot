...
ROBOT_FORWARD_BACKWARD_STEP_TIME = 0.25
ROBOT_LEFT_RIGHT_TURN_STEP_TIME  = 0.04

CORRIDOR_FOLLOWING_PRECISION     = 0.03
ALONG_OBSTACLE_PRECISION         = 0.03
AVOID_OBSTACLE_STOP_DISTANCE     = 0.25
LINE_FOLLOWING_ANGLE_PRECISION   = 5.0
LINE_FOLLOWING_DEFAULT_THRESHOLD = 30
LEFT_RIGHT_TURN_STRENGTH         = 12